...
class PosSessionInherit(models.Model):
    ...
    def _pos_data_process(self, loaded_data):
        ...
        loaded_data['sh_attribute_by_id'] = {data['id']: data for data in loaded_data['product.template.attribute.line']}
        loaded_data['sh_attribute_value_by_id'] = {data['id']: data for data in loaded_data['product.template.attribute.value']}
    ...
    def _loader_params_product_template_attribute_value(self):
        return {'search_params': {'domain': [('product_tmpl_id.available_in_pos','=',True)], 'fields': ['id','name','ptav_active'], 'load': False}}

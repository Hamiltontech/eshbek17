...
export class IshbikPaymentScreen extends Component {
    static template = "hst_ishbik_intgration.IshbikPaymentScreen";
    static components = {
        Numpad,
        IshbikPaymentScreenPaymentLines,
        IshbikPaymentScreenStatus,
    };
    ...
    async validateOrder(isForceValidate) {
        console.log(8888888888888888,isForceValidate);
...
registry.category("pos_screens").add("IshbikPaymentScreen", IshbikPaymentScreen);
